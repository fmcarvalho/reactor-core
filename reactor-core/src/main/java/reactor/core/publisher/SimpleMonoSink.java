 ...
 * @author Simon Baslé
 */
public final class SimpleMonoSink<T> implements MonoSink<T> {
	 ...
	 */
	public SimpleMonoSink() {
		this.processor = MonoProcessor.create();
		this.sink = new MonoCreate.DefaultMonoSink<>(processor);
	}

	/**
	 * Converts the {@link SimpleMonoSink} to a {@link Mono}, allowing to compose
	 * operators on it.
	 * <p>
	 ...
	 *
	 * @return the {@link SimpleMonoSink} viewed as a {@link Mono}
	 */
	...
	/**
	 * Converts the {@link SimpleMonoSink} to a {@link Flux}, allowing to compose
	 * operators on it.
	 *
	 * @return the {@link SimpleMonoSink} viewed as a {@link Flux}
	 */
